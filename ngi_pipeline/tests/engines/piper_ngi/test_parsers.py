...
class TestParsers(unittest.TestCase):
    ...
    def test_parse_results_for_workflow(self, mock_parse):
        ...
        parsed = parsers.parse_results_for_workflow(
            workflow_name, "arg", some_kwarg="Hi"
        )
    ...
    def test_parse_mean_coverage_from_qualimap(self):
        ...
        genome_results_file = os.path.join(
            piper_qc_dir,
            "P123_1001.201112_A00187_0331_AHFCFLDSXX.P123_1001",
            "genome_results.txt",
        )
        ...
        got_coverage = parsers.parse_mean_coverage_from_qualimap(
            piper_qc_dir, sample_id, fcid=fcid
        )
        self.assertEqual(got_coverage, 0.5)
