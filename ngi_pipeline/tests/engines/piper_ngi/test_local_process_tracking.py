...
class TestLocalProcessTracking(unittest.TestCase):
    ...
    @mock.patch('ngi_pipeline.engines.piper_ngi.local_process_tracking.parse_genotype_concordance')
    ...
    def test_update_gtc_for_sample(self, mock_charon, mock_parse):
        ...
        mock_charon().sample_update.assert_called_once_with(genotype_concordance=0.9, 
                                                            projectid='P123', 
                                                            sampleid='P123_1001')

    @mock.patch('ngi_pipeline.engines.piper_ngi.local_process_tracking.parse_deduplication_percentage')
    @mock.patch('ngi_pipeline.engines.piper_ngi.local_process_tracking.parse_qualimap_coverage')
    @mock.patch('ngi_pipeline.engines.piper_ngi.local_process_tracking.parse_qualimap_reads')
    @mock.patch('ngi_pipeline.engines.piper_ngi.local_process_tracking.CharonSession')
    def test_update_sample_duplication_and_coverage(self, mock_charon, mock_reads, mock_cov, mock_dup):
    ...
    @mock.patch('ngi_pipeline.engines.piper_ngi.local_process_tracking.get_finished_seqruns_for_sample')
    @mock.patch('ngi_pipeline.engines.piper_ngi.local_process_tracking.CharonSession')
    @mock.patch('ngi_pipeline.engines.piper_ngi.local_process_tracking.parse_mean_coverage_from_qualimap')
    @mock.patch('ngi_pipeline.engines.piper_ngi.local_process_tracking.parse_qualimap_reads')
    def test_update_coverage_for_sample_seqruns(self, mock_reads, mock_cov, mock_charon, mock_get_seqruns):
    ...
    @mock.patch('ngi_pipeline.engines.piper_ngi.local_process_tracking.create_exit_code_file_path')
