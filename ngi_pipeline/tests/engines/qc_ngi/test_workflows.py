...
class TestWorkflows(unittest.TestCase):
    ...
    def test_workflow_qc(self, mock_fastq_screen, mock_fastqc):
        ...
        expected_command_line_list = [['fastqc', '--option1'], 
                                        ...
                                        "for fl in $files_for_md5; do md5sum $fl | awk '{printf $1}' > ${fl}.md5; done"]]
    ...
    def test_workflow_fastqc(self):
        config = {'paths': {'fastqc': '/path/to/fastqc'},
                    'qc': {'load_modules': ['A']}}
        dummy_fastq = os.path.join(self.tmp_dir, '201111_A00187_0335_AHFCFLDSXX', 'P123_1001.fastq.gz')
    ...
    def test_workflow_fastq_screen(self):
        ...
        command_line_list = workflows.workflow_fastq_screen(input_files, output_dir, config)
    ...
    def test_fastq_to_be_analysed(self):
        ...
        found_fastq = workflows.fastq_to_be_analysed(fastq_files, analysis_dir, output_footers)
        expected_fastq = [[dummy_fastq, os.path.join(analysis_dir, 'P123_1001_AHFCFLDSXX.fastq.gz')]]
