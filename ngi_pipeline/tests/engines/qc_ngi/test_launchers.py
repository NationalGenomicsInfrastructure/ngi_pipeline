...
class TestLaunchers(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        self.project = NGIProject('S.One_20_01', 'dir_P123', 'P123', self.tmp_dir)
    ...
    def test_analyze(self, mock_queue, mock_create, mock_commands):
        ...
        job_file = os.path.join(self.tmp_dir, 'ANALYSIS', 'P123', 'qc_ngi', 'logs', 'P123-P123_1001.slurmjobid')
    ...
    def test_create_sbatch_file(self):
        ...
        out_file = os.path.join(self.tmp_dir, 'ANALYSIS/P123/qc_ngi/logs/P123-P123_1001_sbatch.out')
        err_file = os.path.join(self.tmp_dir, 'ANALYSIS/P123/qc_ngi/logs/P123-P123_1001_sbatch.err')

        got_file = launchers.create_sbatch_file(cl_list, self.project, self.sample, config)
        with open(got_file, 'r') as file:
            got_content = file.read()

        expected_content = """#!/bin/bash -l

#SBATCH -A slurm_proj_id
#SBATCH -p core
#SBATCH -n 16
#SBATCH -t 1-00:00:00
#SBATCH -J qc_P123-P123_1001
#SBATCH -o {}
#SBATCH -e {}
